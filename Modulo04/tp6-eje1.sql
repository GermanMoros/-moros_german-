...
CREATE TABLE `clientes` (
  ...
  `categorÃ­a` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `departamentos` VALUES (9,'DiseÃ±o',100000,1,98000,NULL),(10,'Tester',150000,1,130000,NULL),(11,'DirecciÃ³n',70000,0,60000,NULL),(12,'Analista',50000,1,NULL,NULL),(13,'Implementador',200000,0,110000,NULL),(14,'Marketing',150000,0,130000,NULL),(15,'Ventas',80000,1,70000,NULL),(16,'AtenciÃ³n',40000,1,35000,NULL);
...
INSERT INTO `empleados` VALUES (1,'24-45123544-4','Juan','Rodriguez',9,0,'Lopez 12','juan@hotmail.com','3766547','2022-01-01',NULL,1),(2,'28-48121581-4','Lucas','Lopez',10,1,'Yerbal 14','lucas@hotmail.com','37654874','2022-02-01',NULL,2),(3,'26-45452158-5','RamÃ³n','Rivarola',11,0,'Corrientes 14','ramon@hotmail.com','3762244','2022-02-01',NULL,3),(4,'26-21581265-5','Roman','Toledo',12,1,'Lavalle 15','roman@hotmail.com','3765458','2020-04-01',NULL,4),(5,'27-21555581-4','Ignacio','Ramirez',13,0,'Costanera 15','ignacio@hotmail.com','37555458','2020-05-01',NULL,5),(6,'25-21222281-5','AgustÃ­n','Lopez',14,1,'MaipÃº 78','agustin@gmail.com','37554874','2022-06-01',NULL,1),(7,'26-21583331-6','Lucio','Ramirez',15,1,'Trinchera 484','Lucio@hotmail.com','3755458','2021-07-01',NULL,2),(8,'27-21581774-4','JosÃ©','Rivaldi',16,1,'Avellaneda 45','Jose@gmail.com','37555458','2022-08-01',NULL,6),(9,'26-21581884-6','Pedro','Reinaldi',9,1,'Brasil 78','Pedro@gmail.com','3514874','2021-08-01',NULL,7),(10,'27-21581488-4','Pablo','Rodriguez',10,1,'Uruguay 784','Pablo@gmail.com','37552244','2022-09-01',NULL,8),(11,'26-21581444-6','Hugo','Perez',11,1,'Av. Alem 654','Hugo@gmail.com','3714874','2021-10-01',NULL,9),(12,'26-21581888-6','Tomas','Gomez',12,1,'Bolivar 784','tomas@gmail.com','2512244','2021-11-01',NULL,1);
...
INSERT INTO `localidades` VALUES (1,'Posadas',3300,3),(2,'Apostoles',NULL,3),(3,'OberÃ¡',3360,3),(4,'Puerto IguazÃº',NULL,3),(5,'Eldorado',NULL,3),(6,'Wanda',NULL,3),(7,'Puerto Rico',NULL,3),(8,'Guarani',3361,3),(9,'Panambi',3361,3),(10,'Candelaria',3308,3),(11,'Capiovi',3332,3),(12,'CuiabÃ¡',NULL,15),(13,'Araruna',NULL,14),(14,'Miami',NULL,16);
...
CREATE TABLE `marcas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) DEFAULT NULL,
  `descripciÃ³n` varchar(45) DEFAULT NULL,
  `imagen` blob,
...
INSERT INTO `marcas` VALUES (1,'Samsung','Productos de calidad',NULL,NULL,'0',NULL),(2,'Logitech','Los mejores perifericos',NULL,NULL,'1',NULL),(3,'Noga','Segunda Marca',NULL,3,'0',NULL),(4,'Noganet','No se Fabrica mÃ¡s',NULL,4,'0',NULL),(5,'Cougar','Mejores gabinetes',NULL,9,'1',NULL),(6,'Sentey','Mejores precios',NULL,8,'0',NULL),(7,'Microsoft','Sistemas Operativos',NULL,7,'1',NULL);
...
INSERT INTO `paises` VALUES (1,'Argentina'),(2,'Brasil'),(3,'Paraguay'),(4,'Uruguay'),(5,'Chile'),(6,'EspaÃ±a'),(7,'Estados Unidos');
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`id_vendedor`) REFERENCES `vendedores` (`id`)
...
INSERT INTO `proveedores` VALUES (1,'Sentey SA','Sentey',NULL,'jurÃ­dica','24-32225432-5',1,NULL,NULL),(2,'Logitech SA','Logitech',NULL,'jurÃ­dica','24-32222432-8',2,NULL,NULL),(3,'Noga SA','Noga',NULL,'jurÃ­dica','25-22452332-8',3,NULL,NULL),(4,'Noganet SA','Noganet',NULL,'jurÃ­dica','26-32223242-4',4,NULL,NULL),(5,'Cougar SRL','Cougar',NULL,'jurÃ­dica','25-78452148-8',3,NULL,NULL),(6,'Sony','Sony',NULL,'jurÃ­dica','29-32243332-6',1,NULL,NULL),(7,NULL,'Lucas','AlmirÃ³n','fÃ­sica','20-32444432-1',2,NULL,NULL),(8,NULL,'Juan','Ramirez','fÃ­sica','21-32985432-2',3,NULL,NULL),(9,NULL,'RamÃ³n','Perez','fÃ­sica','22-35432242-1',2,NULL,NULL);
...
INSERT INTO `provincias` VALUES (1,'Ciudad AutÃ³noma de Buenos Aires',1),(2,'Buenos Aires',1),(3,'Misiones',1),(4,'Rosario',1),(5,'CÃ³rdoba',1),(6,'Chaco',1),(7,'Corrientes',1),(8,'Formosa',1),(9,'NeuquÃ©n',1),(11,'TucumÃ¡n',1),(12,'Mendoza',1),(13,'Santa Catarina',2),(14,'ParanÃ¡',2),(15,'Mato Grosso',2),(16,'Florida',7);
...
INSERT INTO `vendedores` VALUES (1,'Juan','LÃ³pez','24-48435484-8',5),(2,'Lucas','Ramirez','25-78451254-7',5),(3,'TomÃ¡s','Perez','25-78462145-9',5),(4,'JosÃ©','Rodriguez','29-45874548-8',5),(5,'JoaquÃ­n','Ramirez','25-78451232-8',5),(6,'Ignacio','Toledo','28-98765421-9',3),(7,'Facundo','Araujo','22-78965432-1',3);
